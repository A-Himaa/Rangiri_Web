  ...
  return (
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-15 md:-mt-20">
     ...
     {/* Right: Contact Info */}
      ...
      {/* Address */}
        <div className="flex items-center gap-3">
        <div className="flex items-center justify-center bg-gray-200 w-full py-5 rounded-md border border-gray-300">
          <FaMapMarkerAlt className="text-[#7b3f2f] text-2xl" />
        </div>
        </div>

        <div className="bg-gray-200 px-4 py-5 rounded-md border border-gray-300 text-gray-700 text-lg leading-relaxed">
          <p className="font-semibold text-[#7b3f2f] mb-1">
